...
import classes from "./SignupDriver.module.css"
import gIcon from "./../../images/gIcon.png"
import { useNavigate } from "react-router-dom";


const SignupDriver =({val})=>{
    const navigate = useNavigate();
    const handleSignup=()=>{
        navigate("/login")
    }
    const handleDriver=()=>{
        navigate("/uploaddriver")
    }
    return(
        <div>
          <Navbar/>
          <div className={classes.cont}>
            <div className={classes.loginWrap}>
              <div className={classes.heading}>Signup as a Driver</div>
              ...
              <div className={classes.loginBtn} onClick={()=>handleDriver()}>
                 Create Account
              </div>
